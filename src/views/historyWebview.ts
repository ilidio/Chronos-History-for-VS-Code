...
export class HistoryViewProvider {
    ...
    private _getSharedStyles() {
        return `
            ...
            .sidebar { flex: 1; display: flex; flex-direction: column; background-color: var(--vscode-sideBar-background); overflow: hidden; }
            ...
            .jb-details-pane { width: 300px; display: none; flex-direction: column; padding: 12px; background: var(--vscode-sideBar-background); border-left: 1px solid var(--vscode-panel-border); overflow-y: auto; }
        `;
    }
